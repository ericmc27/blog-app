...
const ReadBlog = ({useQueryClientFn})=>{
  ...
  const profilePicture = `${import.meta.env.VITE_BACKEND_URL}/static/${cachedBlog ? cachedBlog.profilePicture : currentBlog?.profilePicture}` //need to fix
  ...
  return(
      ...
      <div className="w-175 text-justify whitespace-pre-line">
